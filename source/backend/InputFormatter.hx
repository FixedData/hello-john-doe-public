	...
	public static function keyFormatting(key:FlxKey):String
		{
			return switch (key) {
				...
				//clear invalids
				case ANY | NONE | PRINTSCREEN | PAGEUP | PAGEDOWN | HOME | END | INSERT| ESCAPE | DELETE | BACKSPACE | CAPSLOCK | ENTER | SHIFT | CONTROL | ALT | F1 | F2 | F3 | F4 | F5 | F6 | F7 | F8 | F9 | TAB | UP | DOWN | LEFT | RIGHT: '';
